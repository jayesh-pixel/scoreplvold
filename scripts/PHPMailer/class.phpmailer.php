...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'support@meratemplate.in';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'LifeWEB';

  /**
   * Sets the Sender email address for the message.
   * @var string
   */
  public $SenderEmail        = 'support@meratemplate.in';

  /**
   * Sets the Sender name of the message.
   * @var string
   */
  public $SenderName          = 'LifeWEB';
   ...
   * @var string
   */
  public $Sender            = 'abuse@meratemplate.in';
...
/**
 * Set the Sender and SenderName properties
 * @param string $address
 * @param string $name
 * @return boolean
 */
  ...
  */
  ...
  public function CreateHeader() {
	...
	{
		$sender = array();
		$sender[0][0] = trim($this->SenderEmail);
